...
clean_train_folder = "D:\Main Project\Project\clean_testset_wav"
noisy_train_folder = "D:\Main Project\Project\output1"
...
def process_and_serialize(data_type):
    ...
    for root, dirs, files in os.walk(clean_folder):
        ...
        for filename in tqdm(files, desc='Serialize and down-sample {} audios'.format(data_type)):
            ...
            # print("shape",len(clean_sliced),"shape2",len(noisy_sliced))
            ...
            for idx, slice_tuple in enumerate(zip(clean_sliced, noisy_sliced)):
                ...
                np.save(os.path.join(serialized_folder, '{}_{}'.format(filename, idx)), arr=pair,allow_pickle=True)
